...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      showToast(error.message || "No pudimos iniciar con Google", "error");
      setLoading(false);
    }
  };
      ...
      <div className="scroll-area">
        <div className="max-w-md mx-auto px-6 pt-16 pb-10">
          ...
          <div className="flex gap-3 animate-up d5">
            <button type="button" onClick={handleGoogleLogin} disabled={loading} className="flex-1 h-11 bg-white rounded-[16px] border border-[rgba(0,45,28,0.07)] flex items-center justify-center gap-2 text-sm font-semibold cursor-pointer hover:-translate-y-[2px] hover:shadow-[0_12px_32px_rgba(0,45,28,0.1)] transition-all disabled:opacity-60 disabled:transform-none">
